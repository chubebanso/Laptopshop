                        ...
                        <div class="col-lg-7">
                            ...
                            <form:form method="post" action="/register" modelAttribute="register">
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <form:input  class="form-control ${not empty hasEmailError?'is-invalid':''}" id="inputEmail" type="email"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating mb-3 mb-md-0">
                                                    <c:set var="hasConfirmPasswordError">
                                                        <form:errors path="confirmPassword" cssClass="invalid-feedback" />
                                                    </c:set>
                                                    <form:input class="form-control ${not empty hasConfirmPasswordError?'is-invalid':''}"
                                                        type="password"
