                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="https://hoidanit.vn" target="_blank">
                                ...
                                <p class="text-secondary mb-0">chubebanso</p>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Author:chubebanso</p>
                            <p>Website: <a href="https://hoidanit.vn" target="_blank"> chubebanso.vn</a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="https://hoidanit.vn" target="_blank"><i
                                    class="fas fa-copyright text-light me-2"></i>Chubebanso</a>, All right
                            reserved.</span>
                    </div>
